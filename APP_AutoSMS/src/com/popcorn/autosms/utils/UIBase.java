...
public abstract class UIBase extends Activity {
	...
	public static String REPLY_FILE_NAME="reply";
	public static String REPLY_MESSAGE = "REPLY_MESSAGE";
    public static ReplyMessageUtil replymessageutil ;
	...
	protected void onCreate(Bundle savedInstanceState) {
		 replymessageutil = new ReplyMessageUtil(this.getApplicationContext());
