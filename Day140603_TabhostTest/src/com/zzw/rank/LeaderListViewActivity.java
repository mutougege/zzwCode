...
public class LeaderListViewActivity extends Activity {
	@Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.leader);

        ListView list = (ListView) findViewById(R.id.leader_listview);
        ...
        for(int i=0;i<10;i++)
        {
        	...
        	map.put("ItemTitle", "GOOD "+i);
        	map.put("ItemText", "15.0M");
        	listItem.add(map);
        }
